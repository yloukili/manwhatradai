...
export const elements = {
    ...
    fuseOrientHoriz: document.getElementById('fuse-orient-horiz'),
    fuseP1X: document.getElementById('fuse-p1-x'),
    fuseP1Y: document.getElementById('fuse-p1-y'),
    fuseP1Scale: document.getElementById('fuse-p1-scale'),
    fuseP2X: document.getElementById('fuse-p2-x'),
    fuseP2Y: document.getElementById('fuse-p2-y'),
    fuseP2Scale: document.getElementById('fuse-p2-scale'),
    ...
    rescanConfirmBtn: document.getElementById('rescan-confirm-btn'),
    rescanCancelBtn: document.getElementById('rescan-cancel-btn'),
    rescanBackdrop: document.getElementById('rescan-modal-backdrop'),
